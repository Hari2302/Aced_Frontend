...
const TeacherSidebar = ({ isMobileOpen = false, onCloseMobile }) => {
  const { logout } = useAuth();
  const navigate = useNavigate();

  const navItems = [
    { to: "/teacher/section", label: "Section", icon: "SC" },
    { to: "/teacher/students", label: "Students", icon: "ST" },
    { to: "/teacher/assignments", label: "Assignments", icon: "AS" },
    { to: "/teacher/homework", label: "Homework", icon: "HW" },
    { to: "/teacher/tests", label: "Tests", icon: "TS" },
  ];
