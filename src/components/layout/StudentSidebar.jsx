...
import { clearStudentSession } from "../../services/studentPortalAuth";

const StudentSidebar = ({ isMobileOpen = false, onCloseMobile }) => {
  const navigate = useNavigate();

  const navItems = [
    { to: "/student/dashboard", label: "Dashboard", icon: "DB" },
    { to: "/student/timetable", label: "Timetable", icon: "TT" },
    { to: "/student/assignments", label: "Assignments", icon: "AS" },
    { to: "/student/homework", label: "Homework", icon: "HW" },
    { to: "/student/exams", label: "Tests", icon: "TS" },
    { to: "/student/details", label: "Student Details", icon: "SD" },
    { to: "/student/videos", label: "Video Section", icon: "VD" },
  ];
